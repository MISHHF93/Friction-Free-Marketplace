...
describe("listing validation", () => {
  it("accepts a complete listing payload", () => {
    const result = listingFormSchema.parse({
      ...
      description: "A sturdy mid-century desk with dovetail drawers and only light cosmetic wear.",
      category: "home",
      condition: "good",
      priceAmount: "325.50",
...
describe("Meilisearch payload builder", () => {
  it("adds safety, category, and price filters", () => {
    const payload = buildMeiliSearchPayload({ q: "camera", category: "electronics", minPrice: 100, maxPrice: 500, minSellerTrust: 80 });
