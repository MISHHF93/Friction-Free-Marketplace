...
export const adminNavigationLinks: AdminNavigationLink[] = [
  ...
  { href: "/admin/review-queue", label: "Review queue", description: "Unified trust and safety workflow", permission: "fraud.review" },
  ...
  { href: "/admin/revenue", label: "Revenue", description: "Executive finance summary", permission: "analytics.revenue" },
  { href: "/admin/gmv", label: "GMV", description: "Marketplace volume and status mix", permission: "analytics.revenue" },
  { href: "/admin/fees", label: "Fees", description: "Take rate and deferred fees", permission: "analytics.revenue" },
  { href: "/admin/payouts", label: "Payouts", description: "Seller payables and transfers", permission: "payments.monitor" },
  { href: "/admin/refunds", label: "Refunds", description: "Refund rate and reversals", permission: "payments.monitor" },
  { href: "/admin/reconciliation", label: "Reconciliation", description: "Ledger close readiness", permission: "analytics.revenue" },
